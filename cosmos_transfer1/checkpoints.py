...
BASE_7B_SV2MV_CHECKPOINT_AV_SAMPLE_PATH = f"{COSMOS_TRANSFER1_7B_SAMPLE_AV_CHECKPOINT}/mv_base_model.pt"
SV2MV_t2v_HDMAP2WORLD_CONTROLNET_7B_CHECKPOINT_PATH = f"{COSMOS_TRANSFER1_7B_SAMPLE_AV_CHECKPOINT}/mv_t2v_hdmap_control.pt"
SV2MV_t2v_LIDAR2WORLD_CONTROLNET_7B_CHECKPOINT_PATH = f"{COSMOS_TRANSFER1_7B_SAMPLE_AV_CHECKPOINT}/mv_t2v_lidar_control.pt"
SV2MV_i2v_HDMAP2WORLD_CONTROLNET_7B_CHECKPOINT_PATH = f"{COSMOS_TRANSFER1_7B_SAMPLE_AV_CHECKPOINT}/mv_i2v_hdmap_control.pt"
SV2MV_i2v_LIDAR2WORLD_CONTROLNET_7B_CHECKPOINT_PATH = f"{COSMOS_TRANSFER1_7B_SAMPLE_AV_CHECKPOINT}/mv_i2v_lidar_control.pt"

SV2MV_t2v_BASE_CHECKPOINT_AV_SAMPLE_PATH_dbg = "sv2mv_t2v/iter_000005000_ema_model.pt"
SV2MV_t2v_HDMAP2WORLD_CONTROLNET_7B_CHECKPOINT_PATH_dbg = f"hdmap_sv2mv_t2v_cont_train/fsdp_checkpoints/iter_000018000_ema_model_only.pt"
SV2MV_i2v_BASE_CHECKPOINT_AV_SAMPLE_PATH_dbg = "sv2mv_i2v/iter_000054000_ema_model.pt"
SV2MV_i2v_HDMAP2WORLD_CONTROLNET_7B_CHECKPOINT_PATH_dbg = f"hdmap_sv2mv_i2v/fsdp_checkpoints/iter_000019200_ema_model_only.pt"